...
عند إضافة المدير مكافأة أو مخالفة، يرسل الجسر إلى
`MUWAZANA_MANAGER_EVENT_WEBHOOK_URL` حدثًا من نوع `member.reward.created` أو
`member.penalty.created`. يحتوي الحدث على بيانات العضو والمعاملة والوصف ورابط
الصورة عند إرفاقها، لذلك يمكن لمسار n8n إرسال إشعار مباشر للعضو عبر القناة
المناسبة. لا يحتاج هذا المسار إلى أي رابط webhook إضافي في تطبيق Next.js.
